...
extension AppConfigQueryFilter
  ...
  QueryBuilder<AppConfig, AppConfig, QAfterFilterCondition> passwordIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppConfig, AppConfig, QAfterFilterCondition> passwordEqualTo(
    String? value, {
  ...
  QueryBuilder<AppConfig, AppConfig, QAfterFilterCondition> passwordGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<AppConfig, AppConfig, QAfterFilterCondition> passwordLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<AppConfig, AppConfig, QAfterFilterCondition> passwordBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<AppConfig, AppConfig, QAfterFilterCondition> passwordStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppConfig, AppConfig, QAfterFilterCondition> passwordEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppConfig, AppConfig, QAfterFilterCondition> passwordContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppConfig, AppConfig, QAfterFilterCondition> passwordMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppConfig, AppConfig, QAfterFilterCondition> passwordIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'password',
        value: '',
...
extension AppConfigQuerySortBy on QueryBuilder<AppConfig, AppConfig, QSortBy> {
  QueryBuilder<AppConfig, AppConfig, QAfterSortBy> sortByPassword() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'password', Sort.asc);
    });
  }

  QueryBuilder<AppConfig, AppConfig, QAfterSortBy> sortByPasswordDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension AppConfigQuerySortThenBy
  ...
  QueryBuilder<AppConfig, AppConfig, QAfterSortBy> thenByPassword() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'password', Sort.asc);
    });
  }

  QueryBuilder<AppConfig, AppConfig, QAfterSortBy> thenByPasswordDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'password', Sort.desc);
    });
  }
...
extension AppConfigQueryWhereDistinct
  ...
  QueryBuilder<AppConfig, AppConfig, QDistinct> distinctByPassword(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension AppConfigQueryProperty
  ...
  QueryBuilder<AppConfig, String?, QQueryOperations> passwordProperty() {
    return QueryBuilder.apply(this, (query) {
